...
interface SkinHealthCoachUIProps {
...
export default function SkinHealthCoachUI({ userData, userRatings, amRoutine, pmRoutine, historicalProgress, onBack, onHeaderPress, panHandlers }: SkinHealthCoachUIProps) {
  ...
  const welcomeMessage = `Hey there! 🌟 I'm your Skin Health Coach and I focus on building overall skin wellness from the inside out! 💪

I specialize in holistic approaches to healthy skin - nutrition, lifestyle, hydration, and comprehensive care routines. Let's work together to achieve your healthiest skin ever!`;
        ...
        >
          <View style={styles.headerContent}>
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.coachTitle}>💪 Skin Health Coach</Text>
            </TouchableOpacity>
          </View>
        </LinearGradient>
          ...
          <BlurView intensity={40} tint="dark" style={styles.inputBlurContainer}>
            <View style={styles.inputRow}>
              <TextInput
                ...
                placeholder="Ask me about overall skin health..."
                placeholderTextColor="rgba(245, 232, 163, 0.6)"
                value={message}
              ...
              >
                <LinearGradient
                  colors={isLoading || !message.trim() ? ['#8a8a6a', '#6a6a4a'] : ['#f5e8a3', '#e6d68a']}
...
const styles = StyleSheet.create({
  ...
  userMessageBubble: {
    ...
    marginLeft: 40,
    borderWidth: 1,
    borderColor: 'rgba(245, 232, 163, 0.3)',
  },
  userMessageText: {
    fontSize: 16,
    color: '#FFFFFF',
