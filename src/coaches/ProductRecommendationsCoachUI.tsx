...
interface ProductRecommendationsCoachUIProps {
...
export default function ProductRecommendationsCoachUI({ userData, userRatings, amRoutine, pmRoutine, historicalProgress, onBack, onHeaderPress, panHandlers }: ProductRecommendationsCoachUIProps) {
  ...
  const welcomeMessage = `Hey there! 💄 I'm your Product Recommendations Coach and I'm your personal shopping guide for all things skincare! ✨

I specialize in finding the perfect products for your skin type, budget, and goals. From cleansers to serums to treatments - I'll help you build the perfect skincare arsenal!`;
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch('https://skinai-backend-u6cw.onrender.com/skincare-coach', {
        ...
        body: JSON.stringify({
          message: userMessage,
          coachType: 'product_recommendations',
          userData: userData,
        ...
        >
          <View style={styles.headerContent}>
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.coachTitle}>🧴 Product Recommendations</Text>
            </TouchableOpacity>
          </View>
        </LinearGradient>
          ...
          <BlurView intensity={40} tint="dark" style={styles.inputBlurContainer}>
            <View style={styles.inputRow}>
              <TextInput
                ...
                placeholderTextColor="rgba(255, 194, 224, 0.6)"
                value={message}
              ...
              >
                <LinearGradient
                  colors={isLoading || !message.trim() ? ['#8a6a8a', '#6a4a6a'] : ['#ffc2e0', '#ffb3d9']}
...
const styles = StyleSheet.create({
  ...
  userMessageBubble: {
    ...
    marginLeft: 40,
    borderWidth: 1,
    borderColor: 'rgba(255, 194, 224, 0.3)',
  },
  userMessageText: {
    fontSize: 16,
    color: '#FFFFFF',
