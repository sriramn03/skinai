...
interface PimpleHelpCoachUIProps {
...
export default function PimpleHelpCoachUI({ userData, userRatings, amRoutine, pmRoutine, historicalProgress, onBack, onHeaderPress, panHandlers }: PimpleHelpCoachUIProps) {
  ...
  const welcomeMessage = `Hey there! 🚨 I'm your Pimple Help Coach and I specialize in tackling breakouts, acne spots, and emergency pimple situations! 💪

I'm here to help you treat existing pimples, prevent new ones, and get you through those stressful breakout moments. Let's get your skin back on track - fast!`;
        ...
        >
          <View style={styles.headerContent}>
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
            >
              <Text style={styles.coachTitle}>🔴 Pimple Help Coach</Text>
            </TouchableOpacity>
          </View>
        </LinearGradient>
          ...
          <BlurView intensity={40} tint="dark" style={styles.inputBlurContainer}>
            <View style={styles.inputRow}>
              <TextInput
                ...
                placeholder="Ask me about pimple treatment..."
                placeholderTextColor="rgba(255, 170, 170, 0.6)"
                value={message}
              ...
              >
                <LinearGradient
                  colors={isLoading || !message.trim() ? ['#8a6a6a', '#6a4a4a'] : ['#ffaaaa', '#ff9999']}
